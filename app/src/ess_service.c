...
/* Custom UUIDs for CO2 and TVOC (no standard SIG UUIDs exist) */
#define BT_UUID_CO2_CONCENTRATION_VAL 0x2BD0  /* Custom CO2 UUID */
#define BT_UUID_TVOC_CONCENTRATION_VAL 0x2BE7 /* Custom TVOC UUID */
